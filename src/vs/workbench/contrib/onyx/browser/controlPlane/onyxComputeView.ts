...
/**
 * The local equivalent of a cloud bill: which model is loaded, how fast it
 * generates on this machine, and whether a request is in flight right now.
 */
export class OnyxComputeViewPane extends ViewPane {
	...
	protected override renderBody(container: HTMLElement): void {
		...
		this._register(autorun(reader => {
			this._render(this._controlPlaneService.compute.read(reader));
		}));
	}

	private _render(state: IOnyxComputeState): void {
